...
public class JFrameLista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (jTableLista.getColumnModel().getColumnCount() > 0) {
            jTableLista.getColumnModel().getColumn(0).setPreferredWidth(120);
        }
    ...
    private void jButAleatoriosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButAleatoriosActionPerformed
        ...
        String []prod = {"Laptop","Mouse","Memoria USB","Proyector","Conector","Alexa","Disco Duro","Tablet","Celular","Impresora matriz",
                        "Impresora laser","Impresora inyección","Mouse optico"};
        double []imp = {0,6,10,16,20,40,};
        
        for(int r = 0;r < jTableLista.getRowCount();r++){
            jTableLista.setValueAt(prod[azar.nextInt(prod.length)], r, 0);//Descripcion
            jTableLista.setValueAt(100+azar.nextInt(20001), r, 1);//Costo
            jTableLista.setValueAt(5+azar.nextInt(46), r, 2);//Porcentaje de margen
            jTableLista.setValueAt(azar.nextInt(31), r, 3);//Porcentaje de descuento
    ...
    private void jButPorprecioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButPorprecioActionPerformed
        //Creamos un arrgelo de referencias de objetos de la clase Producto
